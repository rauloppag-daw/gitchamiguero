...
public class GitchamigueroV2Test {
    ...
    public void Testfor11(){
        String resultado = GitchamigueroV2.doGitchamiga(11);
    ...
    public void Testfor14(){
        String resultado = GitchamigueroV2.doGitchamiga(14);
        Assert.assertEquals("14",resultado);
    }

    @Test
    public void Testfor15(){
        String resultado = GitchamigueroV2.doGitchamiga(15);
        Assert.assertEquals("Gachamiga",resultado);
    }

    @Test
    public void Testfor16(){
        String resultado = GitchamigueroV2.doGitchamiga(16);
